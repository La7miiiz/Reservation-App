...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody Utilisateur utilisateur) {
        ...
        var optionalUser = utilisateurRepository.findByEmail(utilisateur.getEmail());

        if (optionalUser.isEmpty() || !passwordEncoder.matches(utilisateur.getMotDePasse(), optionalUser.get().getMotDePasse())) {
